...
function ToastCard() {
    ...
    return (
        <>
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem className='w-full'>
                                        ...
                                        <FormControl>
                                            <Input
                                                placeholder='pages.notifications.toast.messagePlaceholder'
                                                {...field}
                                            />
                                        </FormControl>
                                        <FormDescription>
                                            {t('pages.notifications.toast.messageDescription')}
                                        </FormDescription>
                                        <FormMessage />
                                    </FormItem>
                                )}
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem className='w-full'>
                                        ...
                                        <FormControl>
                                            <Input
                                                placeholder='pages.notifications.toast.descriptionPlaceholder'
                                                {...field}
                                            />
                                        </FormControl>
                                        <FormDescription>
                                            {t('pages.notifications.toast.descriptionDescription')}
                                        </FormDescription>
                                        <FormMessage />
                                    </FormItem>
                                )}
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem className='w-full'>
                                        ...
                                        <FormDescription>
                                            {t('pages.notifications.toast.typeDescription')}
                                        </FormDescription>
                                        <FormMessage />
                                    </FormItem>
                                )}
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem className='w-full'>
                                        ...
                                        <FormDescription>
                                            {t('pages.notifications.toast.positionDescription')}
                                        </FormDescription>
                                        <FormMessage />
                                    </FormItem>
                                )}
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem className='w-full'>
                                        ...
                                        <FormDescription>
                                            {t('pages.notifications.toast.expendDescription')}
                                        </FormDescription>
                                        <FormMessage />
                                    </FormItem>
                                )}
                                        ...
                                        <FormControl>
                                            <div className='flex items-center space-x-2'>
                                                ...
                                                <Label htmlFor='expend'>
                                                    {t('pages.notifications.toast.richColor')}
                                                </Label>
                                            </div>
                                        </FormControl>
                                        <FormDescription>
                                            {t('pages.notifications.toast.richColorDescription')}
                                        </FormDescription>
                                        <FormMessage />
                                    </FormItem>
                                )}
            ...
            <Toaster
                expand={form.watch('expand')}
                richColors={form.watch('richColor')}
